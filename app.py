...
def get_conversational_chain():
    model = ChatGoogleGenerativeAI(model="gemini-2.5-flash", temperature=0.2, maxOutputTokens=1000, topK=6, topP=0.9)
...
def main():
    st.set_page_config(page_title="Chat with your personal medical assistant", layout="wide")
    st.header("Chat with your personal medical assistant")
    ...
    st.markdown(
        ...
        <div style="text-align: center; margin-top: 50px;">
            <strong>This application is powered by <a href="https://www.linkedin.com/in/tia-kavousi/" target="_blank">Tia Kavousi</a></strong>
            <br>
            <a href="https://www.linkedin.com/in/tia-kavousi/" target="_blank">LinkedIn</a> - 
            <a href="https://github.com/tiakavousi" target="_blank">GitHub</a> - 
        </div>
        """, 
